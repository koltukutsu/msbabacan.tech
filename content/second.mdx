...
image: '/images/first/Serverless DB.png'
coverImage: '/images/first/Serverless DB 2.png'
coverImageBlur: '/images/first/Serverless DB 2_blur.png'
coverImageAlt: "Serverless Databases for Serverless & Edge"
---
